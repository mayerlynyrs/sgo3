        ...
        columnDefs: [
            {
                ...
                render: function (data, type, row) { 
                    ...
                    var buttons = '<button   data-id="'+data+'" onclick="myFunction2('+data+')"  title="Aprobar" class="btn btn-green btn-xs btn-flat btnEdit"><i class="fa fa-check-square"></i></button> &nbsp &nbsp &nbsp &nbsp';
