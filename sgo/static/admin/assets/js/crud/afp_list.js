...
function getData() {
    tblAfp = $('#data-table-default').DataTable({
        responsive: true,
        autoWidth: false,
        destroy: true,
        deferRender: true,
...
$(function () {
    ...
    $('.btnAdd').on('click', function () {
        ...
        modal_title.find('span').html('AFP <small style="font-size: 80%;">Nuevo</small>');
    ...
    $('#data-table-default tbody').on('click', 'a[rel="edit"]', function (){
        ...
        modal_title.find('span').html('AFP <small style="font-size: 80%;">Editar</small>');
        modal_title.find('i').removeClass().addClass('fas fa-edit');
        var tr = tblAfp.cell($(this).closest('td, li')).index();
    ...
    $('#data-table-default tbody').on('click', 'a[rel="delete"]', function (){
        ...
        modal_title.find('span').html('AFP <small style="font-size: 80%;">Eliminar</small>');
    ...
    $('#myModalAfp').on('shown.bs.modal', function () {
        //$('form')[0].reset();
    });
