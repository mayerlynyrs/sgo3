...
$(function () {
    ...
    $('.btnAdd').on('click', function () {
        ...
        modal_title.find('span').html('Valor Diario <small style="font-size: 80%;">Nuevo</small>');
    ...
    $('#data-table-default tbody').on('click', 'a[rel="edit"]', function (){
        ...
        modal_title.find('span').html('Valor Diario <small style="font-size: 80%;">Editar</small>');
    ...
    $('#data-table-default tbody').on('click', 'a[rel="delete"]', function (){
        ...
        modal_title.find('span').html('Valor Diario <small style="font-size: 80%;">Eliminar</small>');
    ...
    $('#myModalValorDiario').on('shown.bs.modal', function () {
