        ...
        columnDefs: [
            {
                ...
                render: function (data, type, row) {
                    ...
                    // buttons += '<a href="#" rel="rechazar" title="Finiquito" class="btn btn-info btn-xs btn-flat"><i class="fas fa-dollar-sign"></i></a> &nbsp &nbsp';
                    // buttons += '<button data-id="'+data+'" onclick="myFunctionFiniq('+data+')"  id="btn-view-finiquito" type="button" title="Ver Finiquito" class="btn btn-xs btn-info"><i class="fas fa-dollar-sign"></i></button> &nbsp &nbsp';
