...
$(function () {
    ...
    $('.btnAdd').on('click', function () {
        ...
        modal_title.find('span').html('Motivo Baja' );
    ...
    $('#data-table-default tbody').on('click', 'a[rel="edit"]', function (){
        ...
        modal_title.find('span').html('Edición de un motivo');
    ...
    $('#data-table-default tbody').on('click', 'a[rel="delete"]', function (){
        ...
        modal_title.find('span').html('¿Desea Eliminar el motivo?');
    ...
    $('#myModalArea').on('shown.bs.modal', function () {
        //$('form')[0].reset();
    });
