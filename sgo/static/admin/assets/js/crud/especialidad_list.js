...
$(function () {
    ...
    $('.btnAdd').on('click', function () {
        ...
        modal_title.find('span').html('Especialidad' );
        ...
        $('#myModalEspecialidad').modal('show');
    });

    $('#data-table-default tbody').on('click', 'a[rel="edit"]', function (){
    
        modal_title.find('span').html('Edición de una Especialidad');
    ...
    $('#data-table-default tbody').on('click', 'a[rel="delete"]', function (){
        ...
        modal_title.find('span').html('¿Desea Eliminar Especialidad?');
    ...
    $('#myModalEspecialidad').on('shown.bs.modal', function () {
        //$('form')[0].reset();
    });
